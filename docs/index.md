...
~> **Important:** The examples in this section only set up Flux itself but provide no way for you to actually use it to deploy your own resources via Git. Refer to the next section for how to get started adding your own resources.

These examples show how to connect Flux to various Git providers using different means of authentication.
...
These examples show how to override the default `Kustomization` resource using the `kustomization_override` field. This lets you start getting your own resources deployed from Git, by referencing them in your additions to said `Kustomization`.
