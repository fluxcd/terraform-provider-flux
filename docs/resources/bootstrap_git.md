...
- `kustomization_override` (String) Kustomization YAML to override configuration set by default.
...
- `version` (String) Flux version. Defaults to `v2.8.6`. Has no effect when `embedded_manifests` is enabled.
